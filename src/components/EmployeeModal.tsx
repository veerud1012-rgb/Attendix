        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex flex-col items-center justify-center space-y-2">
                  <div className="relative">
                    <img
                      ...
                      className="w-16 h-16 rounded-full object-cover border-2 border-emerald-500 shadow-sm mx-auto"
                    />
                    <button
                      type="button"
                  ...
                  <p className="text-[10px] text-emerald-600 font-bold">Image selected successfully!</p>
                </div>
              ) : (
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 rounded-xl text-xs border focus:outline-none transition-all duration-300 ${
                darkMode 
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[10px] text-[#2bdfff] font-medium leading-none font-mono">
              Auto-calculated daily wages: Approximately ₹{monthlySalary ? Math.round(Number(monthlySalary) / 30) : 0} per day.
            </p>
          </div>

          {/* Overtime Settings Rule */}
          <div className={`p-4 rounded-[18px] border space-y-3.5 ${
            ...
            <p className={`text-[10px] leading-relaxed ${darkMode ? "text-[#b9c2d9]" : "text-gray-500"}`}>
