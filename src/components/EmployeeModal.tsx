  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative w-full max-w-lg rounded-[22px] overflow-hidden flex flex-col max-h-[calc(100vh-2rem)] transition-all duration-300 transform scale-100 ${
        ...
        {/* Modal Header */}
        <div className="flex justify-between items-center px-4 sm:px-6 py-3.5 sm:py-4.5 border-b border-white/8 flex-shrink-0">
          <div className="flex items-center gap-2 sm:gap-2.5">
            <div className="p-1.5 sm:p-2 bg-[#6d28ff]/15 rounded-xl text-[#9b5dff] shadow-[0_0_10px_rgba(155,93,255,0.2)]">
              <UserPlus className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <h3 className="text-sm sm:text-base font-extrabold font-display leading-none tracking-tight">
                {initialData ? "Edit Employee" : "Register New Employee"}
              </h3>
              <p className={`text-[10px] sm:text-[11px] mt-1 sm:mt-1.5 ${darkMode ? "text-[#8e97af]" : "text-gray-500"}`}>
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3 sm:space-y-4 min-h-0">
            {error && (
              <div className="p-2.5 sm:p-3 text-xs bg-rose-500/10 border border-rose-500/20 rounded-lg text-rose-400 font-medium">
                ⚠️ {error}
              </div>
            )}
            ...
            <div className="space-y-1 sm:space-y-1.5">
              <label className={`text-[9px] sm:text-[10px] font-bold tracking-wider uppercase ${
                darkMode ? "text-[#8e97af]" : "text-slate-600"
              }`}>
                Employee Image
              </label>
              <div
                className={`border-2 border-dashed rounded-xl p-2.5 sm:p-3 transition-all duration-200 text-center relative ${
                  isDragging
              ...
              >
                {employeeImage ? (
                  <div className="flex flex-col items-center justify-center space-y-1 sm:space-y-1.5">
                    <div className="relative">
                      <img
                        ...
                        className="w-10 h-10 sm:w-14 sm:h-14 rounded-full object-cover border-2 border-emerald-500 shadow-sm mx-auto"
                      />
                      <button
                        type="button"
                  ...
                  <label className="cursor-pointer block space-y-0.5">
                    <input
                      type="file"
                      accept="image/*"
                    ...
                    <p className={`text-[11px] sm:text-xs font-semibold ${darkMode ? "text-slate-200" : "text-slate-700"}`}>
                      Drag & drop or <span className="text-indigo-600 underline hover:text-indigo-700">click to upload</span>
                    </p>
                    <p className={`text-[8px] sm:text-[9px] ${darkMode ? "text-[#8e97af]" : "text-slate-400"}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="space-y-1 sm:space-y-1.5">
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-[10px] sm:text-xs">
                    👤
                  </span>
                  <input
                    ...
                    className={`w-full pl-8 pr-3 py-1.5 sm:py-2 rounded-xl text-xs border focus:outline-none transition-all duration-300 ${
                      darkMode 
              ...
              <div className="space-y-1 sm:space-y-1.5">
                ...
                <div className="relative">
                  <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#8e97af]" />
                  <input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="space-y-1 sm:space-y-1.5">
                ...
                <input
                  ...
                  className={`w-full px-3 py-1.5 sm:py-2 rounded-xl text-xs border focus:outline-none transition-all duration-300 ${
                    darkMode 
              ...
              <div className="space-y-1 sm:space-y-1.5">
                ...
                <div className="relative">
                  <IndianRupee className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#8e97af]" />
                  <input
                ...
                <p className="text-[8.5px] text-[#2bdfff] font-medium leading-tight font-mono">
            ...
            <div className={`p-3 rounded-[15px] sm:rounded-[18px] border space-y-2 ${
              ...
              <div className="flex items-center gap-1.5 text-[#c084fc] drop-shadow-[0_0_4px_rgba(168,85,247,0.4)]">
                ...
                <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-wider">Overtime Compensation Matrix</span>
              </div>
              
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3.5">
                <div className="space-y-0.5 sm:space-y-1">
                  <label className="text-[8px] sm:text-[9px] uppercase font-bold text-[#8e97af]">Target Hours</label>
                  <input
                    ...
                    min="0.5"
                    step="0.5"
                    className={`w-full px-2 py-0.5 sm:py-1 rounded-lg text-xs border focus:outline-none transition-all ${
                      darkMode 
                ...
                <div className="space-y-0.5 sm:space-y-1">
                  <label className="text-[8px] sm:text-[9px] uppercase font-bold text-[#8e97af]">Payout Rate (₹)</label>
                  <input
              ...
              <p className={`text-[8.5px] sm:text-[9.5px] leading-relaxed ${darkMode ? "text-[#b9c2d9]" : "text-gray-500"}`}>
          ...
          <div className={`px-4 sm:px-6 py-3.5 sm:py-4.5 border-t flex justify-end gap-2.5 sm:gap-3 flex-shrink-0 ${
            ...
            <button
              ...
              type="submit"
              className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer ${
                darkMode 
